...
@property (class, readonly, getter=companion) XNetworkingFearlessChainsBuilderCompanion *companion __attribute__((swift_name("companion")));
...
@interface XNetworkingFearlessChainsBuilderCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingFearlessChainsBuilderCompanion *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PlatformNotFoundException")))
@interface XNetworkingPlatformNotFoundException : XNetworkingChainBuilderException
- (instancetype)initWithMessage:(NSString *)message cause:(XNetworkingKotlinThrowable * _Nullable)cause __attribute__((swift_name("init(message:cause:)"))) __attribute__((objc_designated_initializer));
@end;
...
- (NSArray<XNetworkingChainModel *> *)component1 __attribute__((swift_name("component1()")));
- (NSArray<XNetworkingChainModel *> *)component2 __attribute__((swift_name("component2()")));
...
- (NSArray<XNetworkingReferrerReward *> *)component1 __attribute__((swift_name("component1()")));
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingDouble * _Nullable)component2 __attribute__((swift_name("component2()")));
- (XNetworkingDouble * _Nullable)component3 __attribute__((swift_name("component3()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getReferrerRewardsAddress:(NSString *)address url:(NSString *)url completionHandler:(void (^)(XNetworkingReferrerRewardsInfo * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getReferrerRewards(address:url:completionHandler:)")));

/**
 @note This method converts instances of SoramitsuNetworkException, CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getSpApyUrl:(NSString *)url completionHandler:(void (^)(NSArray<XNetworkingSbApyInfo *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getSpApy(url:completionHandler:)")));
- (XNetworkingSubQueryHistoryInfo *)getTransactionCachedAddress:(NSString *)address networkName:(NSString *)networkName txHash:(NSString *)txHash __attribute__((swift_name("getTransactionCached(address:networkName:txHash:)")));
- (XNetworkingSubQueryHistoryInfo *)getTransactionHistoryCachedAddress:(NSString *)address networkName:(NSString *)networkName __attribute__((swift_name("getTransactionHistoryCached(address:networkName:)")));
...
@interface XNetworkingSubQueryMapper : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)subQueryMapper __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingSubQueryMapper *shared __attribute__((swift_name("shared")));
- (NSArray<XNetworkingSbApyInfo *> *)mapSubQuerySbApyResponse:(XNetworkingSubQuerySbApyResponse *)subQuerySbApyResponse __attribute__((swift_name("map(subQuerySbApyResponse:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseData")))
@interface XNetworkingPoolsInfoResponseData : XNetworkingBase
...
@property (class, readonly, getter=companion) XNetworkingPoolsInfoResponseDataCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (XNetworkingPoolsInfoResponseData *)doCopyTargetAssetId:(NSString *)targetAssetId priceUSD:(NSString * _Nullable)priceUSD strategicBonusApy:(NSString * _Nullable)strategicBonusApy __attribute__((swift_name("doCopy(targetAssetId:priceUSD:strategicBonusApy:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface XNetworkingPoolsInfoResponseDataCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingPoolsInfoResponseDataCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseDataElement")))
@interface XNetworkingPoolsInfoResponseDataElement : XNetworkingBase
- (instancetype)initWithNode:(XNetworkingPoolsInfoResponseData *)node __attribute__((swift_name("init(node:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingPoolsInfoResponseDataElementCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingPoolsInfoResponseData *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingPoolsInfoResponseDataElement *)doCopyNode:(XNetworkingPoolsInfoResponseData *)node __attribute__((swift_name("doCopy(node:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingPoolsInfoResponseData *node __attribute__((swift_name("node")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseDataElement.Companion")))
@interface XNetworkingPoolsInfoResponseDataElementCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingPoolsInfoResponseDataElementCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseNodes")))
@interface XNetworkingPoolsInfoResponseNodes : XNetworkingBase
- (instancetype)initWithNodes:(NSArray<XNetworkingPoolsInfoResponseNodesElement *> *)nodes __attribute__((swift_name("init(nodes:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingPoolsInfoResponseNodesCompanion *companion __attribute__((swift_name("companion")));
- (NSArray<XNetworkingPoolsInfoResponseNodesElement *> *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingPoolsInfoResponseNodes *)doCopyNodes:(NSArray<XNetworkingPoolsInfoResponseNodesElement *> *)nodes __attribute__((swift_name("doCopy(nodes:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<XNetworkingPoolsInfoResponseNodesElement *> *nodes __attribute__((swift_name("nodes")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseNodes.Companion")))
@interface XNetworkingPoolsInfoResponseNodesCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingPoolsInfoResponseNodesCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseNodesElement")))
@interface XNetworkingPoolsInfoResponseNodesElement : XNetworkingBase
- (instancetype)initWithPools:(XNetworkingPoolsInfoResponsePools *)pools __attribute__((swift_name("init(pools:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingPoolsInfoResponseNodesElementCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingPoolsInfoResponsePools *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingPoolsInfoResponseNodesElement *)doCopyPools:(XNetworkingPoolsInfoResponsePools *)pools __attribute__((swift_name("doCopy(pools:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingPoolsInfoResponsePools *pools __attribute__((swift_name("pools")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponseNodesElement.Companion")))
@interface XNetworkingPoolsInfoResponseNodesElementCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingPoolsInfoResponseNodesElementCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponsePoolXykEntity")))
@interface XNetworkingPoolsInfoResponsePoolXykEntity : XNetworkingBase
- (instancetype)initWithPoolXYKEntities:(XNetworkingPoolsInfoResponseNodes *)poolXYKEntities __attribute__((swift_name("init(poolXYKEntities:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingPoolsInfoResponsePoolXykEntityCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingPoolsInfoResponseNodes *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingPoolsInfoResponsePoolXykEntity *)doCopyPoolXYKEntities:(XNetworkingPoolsInfoResponseNodes *)poolXYKEntities __attribute__((swift_name("doCopy(poolXYKEntities:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingPoolsInfoResponseNodes *poolXYKEntities __attribute__((swift_name("poolXYKEntities")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponsePoolXykEntity.Companion")))
@interface XNetworkingPoolsInfoResponsePoolXykEntityCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingPoolsInfoResponsePoolXykEntityCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponsePools")))
@interface XNetworkingPoolsInfoResponsePools : XNetworkingBase
- (instancetype)initWithEdges:(NSArray<XNetworkingPoolsInfoResponseDataElement *> *)edges __attribute__((swift_name("init(edges:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingPoolsInfoResponsePoolsCompanion *companion __attribute__((swift_name("companion")));
- (NSArray<XNetworkingPoolsInfoResponseDataElement *> *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingPoolsInfoResponsePools *)doCopyEdges:(NSArray<XNetworkingPoolsInfoResponseDataElement *> *)edges __attribute__((swift_name("doCopy(edges:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<XNetworkingPoolsInfoResponseDataElement *> *edges __attribute__((swift_name("edges")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PoolsInfoResponsePools.Companion")))
@interface XNetworkingPoolsInfoResponsePoolsCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingPoolsInfoResponsePoolsCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsData")))
@interface XNetworkingReferrerRewardsData : XNetworkingBase
- (instancetype)initWithPageInfo:(XNetworkingReferrerRewardsPageInfo *)pageInfo nodes:(NSArray<XNetworkingReferrerRewardsItem *> *)nodes __attribute__((swift_name("init(pageInfo:nodes:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingReferrerRewardsDataCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingReferrerRewardsPageInfo *)component1 __attribute__((swift_name("component1()")));
- (NSArray<XNetworkingReferrerRewardsItem *> *)component2 __attribute__((swift_name("component2()")));
- (XNetworkingReferrerRewardsData *)doCopyPageInfo:(XNetworkingReferrerRewardsPageInfo *)pageInfo nodes:(NSArray<XNetworkingReferrerRewardsItem *> *)nodes __attribute__((swift_name("doCopy(pageInfo:nodes:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<XNetworkingReferrerRewardsItem *> *nodes __attribute__((swift_name("nodes")));
@property (readonly) XNetworkingReferrerRewardsPageInfo *pageInfo __attribute__((swift_name("pageInfo")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsData.Companion")))
@interface XNetworkingReferrerRewardsDataCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingReferrerRewardsDataCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsItem")))
@interface XNetworkingReferrerRewardsItem : XNetworkingBase
- (instancetype)initWithReferral:(NSString *)referral amount:(NSString *)amount __attribute__((swift_name("init(referral:amount:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingReferrerRewardsItemCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (XNetworkingReferrerRewardsItem *)doCopyReferral:(NSString *)referral amount:(NSString *)amount __attribute__((swift_name("doCopy(referral:amount:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *amount __attribute__((swift_name("amount")));
...
@interface XNetworkingReferrerRewardsItemCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingReferrerRewardsItemCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsPageInfo")))
@interface XNetworkingReferrerRewardsPageInfo : XNetworkingBase
...
@property (class, readonly, getter=companion) XNetworkingReferrerRewardsPageInfoCompanion *companion __attribute__((swift_name("companion")));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (XNetworkingReferrerRewardsPageInfo *)doCopyHasNextPage:(BOOL)hasNextPage endCursor:(NSString * _Nullable)endCursor __attribute__((swift_name("doCopy(hasNextPage:endCursor:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface XNetworkingReferrerRewardsPageInfoCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingReferrerRewardsPageInfoCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsResponse")))
@interface XNetworkingReferrerRewardsResponse : XNetworkingBase
- (instancetype)initWithData:(XNetworkingReferrerRewardsResponseData *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingReferrerRewardsResponseCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingReferrerRewardsResponseData *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingReferrerRewardsResponse *)doCopyData:(XNetworkingReferrerRewardsResponseData *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingReferrerRewardsResponseData *data __attribute__((swift_name("data")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsResponse.Companion")))
@interface XNetworkingReferrerRewardsResponseCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingReferrerRewardsResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsResponseData")))
@interface XNetworkingReferrerRewardsResponseData : XNetworkingBase
- (instancetype)initWithReferrerRewards:(XNetworkingReferrerRewardsData *)referrerRewards __attribute__((swift_name("init(referrerRewards:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingReferrerRewardsResponseDataCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingReferrerRewardsData *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingReferrerRewardsResponseData *)doCopyReferrerRewards:(XNetworkingReferrerRewardsData *)referrerRewards __attribute__((swift_name("doCopy(referrerRewards:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingReferrerRewardsData *referrerRewards __attribute__((swift_name("referrerRewards")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ReferrerRewardsResponseData.Companion")))
@interface XNetworkingReferrerRewardsResponseDataCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingReferrerRewardsResponseDataCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubQuerySbApyResponse")))
@interface XNetworkingSubQuerySbApyResponse : XNetworkingBase
- (instancetype)initWithData:(XNetworkingPoolsInfoResponsePoolXykEntity *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingSubQuerySbApyResponseCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingPoolsInfoResponsePoolXykEntity *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingSubQuerySbApyResponse *)doCopyData:(XNetworkingPoolsInfoResponsePoolXykEntity *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingPoolsInfoResponsePoolXykEntity *data __attribute__((swift_name("data")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubQuerySbApyResponse.Companion")))
@interface XNetworkingSubQuerySbApyResponseCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingSubQuerySbApyResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end;
...
- (XNetworkingSubQueryClient<XNetworkingFearlessSubQueryResponse *, XNetworkingSubQueryHistoryItem *> *)buildSoramitsuNetworkClient:(XNetworkingSoramitsuNetworkClient *)soramitsuNetworkClient baseUrl:(NSString *)baseUrl pageSize:(int32_t)pageSize __attribute__((swift_name("build(soramitsuNetworkClient:baseUrl:pageSize:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubQueryClientForSora")))
@interface XNetworkingSubQueryClientForSora : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)subQueryClientForSora __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingSubQueryClientForSora *shared __attribute__((swift_name("shared")));
- (XNetworkingSubQueryClient<XNetworkingSoraSubqueryResponse *, XNetworkingSubQueryHistoryItem *> *)buildSoramitsuNetworkClient:(XNetworkingSoramitsuNetworkClient *)soramitsuNetworkClient baseUrl:(NSString *)baseUrl pageSize:(int32_t)pageSize __attribute__((swift_name("build(soramitsuNetworkClient:baseUrl:pageSize:)")));
@end;
...
- (XNetworkingSubQueryHistoryItemNested *)mapItemNestedExtrinsic:(XNetworkingExtrinsics *)extrinsic params:(NSArray<XNetworkingExtrinsicParam *> *)params __attribute__((swift_name("mapItemNested(extrinsic:params:)")));
- (XNetworkingSubQueryHistoryItem *)mapItemsExtrinsic:(XNetworkingExtrinsics *)extrinsic params:(NSArray<XNetworkingSubQueryHistoryItemNested *> *)params __attribute__((swift_name("mapItems(extrinsic:params:)")));
- (XNetworkingSubQueryHistoryItem *)mapParamsExtrinsic:(XNetworkingExtrinsics *)extrinsic params:(NSArray<XNetworkingExtrinsicParam *> *)params __attribute__((swift_name("mapParams(extrinsic:params:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubQueryHistoryInfo")))
@interface XNetworkingSubQueryHistoryInfo : XNetworkingBase
- (instancetype)initWithEndCursor:(NSString * _Nullable)endCursor endReached:(BOOL)endReached items:(NSArray<XNetworkingSubQueryHistoryItem *> *)items __attribute__((swift_name("init(endCursor:endReached:items:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (BOOL)component2 __attribute__((swift_name("component2()")));
- (NSArray<XNetworkingSubQueryHistoryItem *> *)component3 __attribute__((swift_name("component3()")));
- (XNetworkingSubQueryHistoryInfo *)doCopyEndCursor:(NSString * _Nullable)endCursor endReached:(BOOL)endReached items:(NSArray<XNetworkingSubQueryHistoryItem *> *)items __attribute__((swift_name("doCopy(endCursor:endReached:items:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable endCursor __attribute__((swift_name("endCursor")));
@property (readonly) BOOL endReached __attribute__((swift_name("endReached")));
@property (readonly) NSArray<XNetworkingSubQueryHistoryItem *> *items __attribute__((swift_name("items")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SubQueryHistoryItem")))
@interface XNetworkingSubQueryHistoryItem : XNetworkingBase
- (instancetype)initWithId:(NSString *)id blockHash:(NSString *)blockHash module:(NSString *)module method:(NSString *)method timestamp:(NSString *)timestamp networkFee:(NSString *)networkFee success:(BOOL)success data:(NSArray<XNetworkingSubQueryHistoryItemParam *> * _Nullable)data nestedData:(NSArray<XNetworkingSubQueryHistoryItemNested *> * _Nullable)nestedData __attribute__((swift_name("init(id:blockHash:module:method:timestamp:networkFee:success:data:nestedData:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
...
- (NSArray<XNetworkingSubQueryHistoryItemParam *> * _Nullable)component8 __attribute__((swift_name("component8()")));
- (NSArray<XNetworkingSubQueryHistoryItemNested *> * _Nullable)component9 __attribute__((swift_name("component9()")));
- (XNetworkingSubQueryHistoryItem *)doCopyId:(NSString *)id blockHash:(NSString *)blockHash module:(NSString *)module method:(NSString *)method timestamp:(NSString *)timestamp networkFee:(NSString *)networkFee success:(BOOL)success data:(NSArray<XNetworkingSubQueryHistoryItemParam *> * _Nullable)data nestedData:(NSArray<XNetworkingSubQueryHistoryItemNested *> * _Nullable)nestedData __attribute__((swift_name("doCopy(id:blockHash:module:method:timestamp:networkFee:success:data:nestedData:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *blockHash __attribute__((swift_name("blockHash")));
@property (readonly) NSArray<XNetworkingSubQueryHistoryItemParam *> * _Nullable data __attribute__((swift_name("data")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
...
@property (readonly) NSArray<XNetworkingSubQueryHistoryItemNested *> * _Nullable nestedData __attribute__((swift_name("nestedData")));
...
@interface XNetworkingSubQueryHistoryItemNested : XNetworkingBase
- (instancetype)initWithModule:(NSString *)module method:(NSString *)method hash:(NSString *)hash data:(NSArray<XNetworkingSubQueryHistoryItemParam *> *)data __attribute__((swift_name("init(module:method:hash:data:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (NSArray<XNetworkingSubQueryHistoryItemParam *> *)component4 __attribute__((swift_name("component4()")));
- (XNetworkingSubQueryHistoryItemNested *)doCopyModule:(NSString *)module method:(NSString *)method hash:(NSString *)hash data:(NSArray<XNetworkingSubQueryHistoryItemParam *> *)data __attribute__((swift_name("doCopy(module:method:hash:data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<XNetworkingSubQueryHistoryItemParam *> *data __attribute__((swift_name("data")));
@property (readonly, getter=hash_) NSString *hash __attribute__((swift_name("hash")));
@property (readonly) NSString *method __attribute__((swift_name("method")));
@property (readonly) NSString *module __attribute__((swift_name("module")));
@end;
...
@interface XNetworkingSubQueryHistoryItemParam : XNetworkingBase
...
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (XNetworkingSubQueryHistoryItemParam *)doCopyParamName:(NSString *)paramName paramValue:(NSString *)paramValue __attribute__((swift_name("doCopy(paramName:paramValue:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface XNetworkingSubQueryHistoryResult<R> : XNetworkingBase
...
- (NSArray<XNetworkingFearlessHistoryResponseItem *> *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingFearlessHistoryResponsePageInfo *)component2 __attribute__((swift_name("component2()")));
...
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (XNetworkingFearlessRewardItem * _Nullable)component4 __attribute__((swift_name("component4()")));
- (XNetworkingFearlessTransferItem * _Nullable)component5 __attribute__((swift_name("component5()")));
- (XNetworkingFearlessExtrinsicItem * _Nullable)component6 __attribute__((swift_name("component6()")));
...
- (XNetworkingFearlessSubQueryResponseData *)component1 __attribute__((swift_name("component1()")));
...
- (XNetworkingFearlessHistoryResponseDataElements *)component1 __attribute__((swift_name("component1()")));
...
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (XNetworkingInt * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
...
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (XNetworkingError * _Nullable)component2 __attribute__((swift_name("component2()")));
...
- (NSArray<XNetworkingHistoryResponseItem *> *)component1 __attribute__((swift_name("component1()")));
- (XNetworkingHistoryResponsePageInfo *)component2 __attribute__((swift_name("component2()")));
...
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
- (XNetworkingExecutionResult *)component7 __attribute__((swift_name("component7()")));
- (XNetworkingKotlinx_serialization_jsonJsonElement *)component8 __attribute__((swift_name("component8()")));
...
- (XNetworkingSoraSubqueryResponseData *)component1 __attribute__((swift_name("component1()")));
...
- (XNetworkingHistoryResponseDataElements *)component1 __attribute__((swift_name("component1()")));
...
- (instancetype)initWithHistoryDatabaseFactory:(XNetworkingDatabaseDriverFactory *)historyDatabaseFactory __attribute__((swift_name("init(historyDatabaseFactory:)"))) __attribute__((objc_designated_initializer));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)collectCollector:(id<XNetworkingKotlinx_coroutines_coreFlowCollector>)collector completionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("collect(collector:completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)emitValue:(id _Nullable)value completionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("emit(value:completionHandler:)")));
@end;
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (XNetworkingByte *)next __attribute__((swift_name("next()")));
...
- (XNetworkingKtor_utilsTypeInfo *)component1 __attribute__((swift_name("component1()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)joinWithCompletionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("join(completionHandler:)")));
...
- (XNetworkingKtor_utilsWeekDay *)component4 __attribute__((swift_name("component4()")));
- (int32_t)component5 __attribute__((swift_name("component5()")));
- (int32_t)component6 __attribute__((swift_name("component6()")));
- (XNetworkingKtor_utilsMonth *)component7 __attribute__((swift_name("component7()")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)awaitContentWithCompletionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("awaitContent(completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(XNetworkingKtor_ioChunkBuffer *)dst n:(int32_t)n completionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:n:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(XNetworkingKotlinByteArray *)dst offset:(int32_t)offset length:(int32_t)length completionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:offset:length:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(void *)dst offset:(int32_t)offset length:(int32_t)length completionHandler_:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:offset:length:completionHandler_:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readFullyDst:(void *)dst offset:(int64_t)offset length:(int64_t)length completionHandler__:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readFully(dst:offset:length:completionHandler__:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)readSuspendableSessionConsumer:(id<XNetworkingKotlinSuspendFunction1>)consumer completionHandler:(void (^)(XNetworkingKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("readSuspendableSession(consumer:completionHandler:)"))) __attribute__((deprecated("Use read { } instead.")));
...
- (id<XNetworkingKotlinKClass>)component1 __attribute__((swift_name("component1()")));
- (id<XNetworkingKotlinKType>)component2 __attribute__((swift_name("component2()")));
- (id<XNetworkingKotlinKType> _Nullable)component3 __attribute__((swift_name("component3()")));
...
- (XNetworkingKotlinKVariance * _Nullable)component1 __attribute__((swift_name("component1()")));
- (id<XNetworkingKotlinKType> _Nullable)component2 __attribute__((swift_name("component2()")));
