 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getAssetsInfoTokenIds:(NSArray<NSString *> *)tokenIds timestamp:(int64_t)timestamp completionHandler:(void (^)(NSArray<XNetworkingAssetsInfo *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getAssetsInfo(tokenIds:timestamp:completionHandler:)")));
...
- (instancetype)initWithTokenId:(NSString *)tokenId liquidity:(NSString *)liquidity hourDelta:(XNetworkingDouble * _Nullable)hourDelta __attribute__((swift_name("init(tokenId:liquidity:hourDelta:)"))) __attribute__((objc_designated_initializer));
- (XNetworkingAssetsInfo *)doCopyTokenId:(NSString *)tokenId liquidity:(NSString *)liquidity hourDelta:(XNetworkingDouble * _Nullable)hourDelta __attribute__((swift_name("doCopy(tokenId:liquidity:hourDelta:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingDouble * _Nullable hourDelta __attribute__((swift_name("hourDelta")));
...
- (instancetype)initWithId:(NSString *)id liquidity:(NSString *)liquidity periods:(XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHour *)periods __attribute__((swift_name("init(id:liquidity:periods:)"))) __attribute__((objc_designated_initializer));
...
- (XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNode *)doCopyId:(NSString *)id liquidity:(NSString *)liquidity periods:(XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHour *)periods __attribute__((swift_name("doCopy(id:liquidity:periods:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
@property (readonly) NSString *liquidity __attribute__((swift_name("liquidity")));
@property (readonly) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHour *periods __attribute__((swift_name("periods")));
@end
...
@interface XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHour : XNetworkingBase
- (instancetype)initWithNodes:(NSArray<XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNode *> *)nodes __attribute__((swift_name("init(nodes:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHour *)doCopyNodes:(NSArray<XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNode *> *)nodes __attribute__((swift_name("doCopy(nodes:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNode *> *nodes __attribute__((swift_name("nodes")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SoraWalletAssetsCase0ResponseDataEntitiesNodeHour.Companion")))
@interface XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNode : XNetworkingBase
- (instancetype)initWithPrice:(XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePrice *)price __attribute__((swift_name("init(price:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodeCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNode *)doCopyPrice:(XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePrice *)price __attribute__((swift_name("doCopy(price:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePrice *price __attribute__((swift_name("price")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SoraWalletAssetsCase0ResponseDataEntitiesNodeHourNode.Companion")))
@interface XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodeCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodeCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePrice : XNetworkingBase
...
@property (class, readonly, getter=companion) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePriceCompanion *companion __attribute__((swift_name("companion")));
- (XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePrice *)doCopyLow:(NSString *)low high:(NSString *)high open:(NSString *)open close:(NSString *)close __attribute__((swift_name("doCopy(low:high:open:close:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePriceCompanion : XNetworkingBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) XNetworkingSoraWalletAssetsCase0ResponseDataEntitiesNodeHourNodePriceCompanion *shared __attribute__((swift_name("shared")));
- (id<XNetworkingKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
